        ...
        <div class="content-header">
            ...
            <div class="side_border">
                ...
                <h4 class="account_totals">
                    <span class="unpaid-balance"><?php echo __('kitchen:unpaid_balance', array(Currency::format($client->unpaid_total))) ?></span><br />
                    <span class="total-to-date"><?php echo __('kitchen:total_paid_to_date', array(Currency::format($client->paid_total)))?></span>
                </h4>
            </div>
            <div class="clear">&nbsp;</div>
        </div>
		...
		<div id="project-details-holder">
			...
			<?php foreach ($project->tasks as $task): ?>
				...
				<tr class="items-desc-row task-row" >
					...
					<td style="white-space: nowrap;" class="hours-col"><?php echo format_hours($task['tracked_hours']); ?></td>
