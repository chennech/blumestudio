...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    ...
    <head>
        ...
        <?php if (!$pdf_mode): ?>
            <?php echo asset::css('facebox.css', array('media' => 'all'), NULL, $pdf_mode); ?>
                    ...
                    <table border="0" cellspacing="5" cellpadding="5" width="100%">
			            ...
			            <span class="clientAddress editable"><?php echo stristr($proposal['client']['address'], '<br') !== false ? $proposal['client']['address'] : nl2br($proposal['client']['address']);?></span>
                            ...
                            <td class="logo-brand-details">
                                <p><?php echo Business::getLogo(false, false, null);?><br /><?php echo Business::getHtmlEscapedMailingAddress(); ?></p>
                            </td>
                        </tr>
                    </table>
                </div><!-- /envelope -->
