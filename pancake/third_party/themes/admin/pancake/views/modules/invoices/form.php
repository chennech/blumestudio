            ...
            <?php if ($type == "DETAILED"): ?>
                <?php if (!$is_edit or ( !$invoice->is_recurring or ( $invoice->recur_id == $invoice->id))) : ?>
                    ...
                    <div id="recurring-options" style="display:none">
                        ...
                        <div class="dropdown-arrow">
                            <?php echo form_dropdown('auto_send', array(__('global:no'), __('global:yes')), set_value('auto_send', $is_edit ? $invoice->auto_send : 1), 'id="auto_send"'); ?>
                        </div>
            ...
            <fieldset>
                                        ...
                                        <table class="sub-invoice-table">
                                            <tr class="details">
                                                ...
                                                <td class="tax-row tax-dropdown">
                                                    <select id="invoice_item_tax_ids" name="invoice_item[tax_id][][]" multiple="multiple" class="multiselect">
                    ...
                    <div class="row">
                        ...
                        <div class="textarea">
                            ...
                            echo form_textarea(array(
                                'name' => 'notes',
                                'id' => 'notes',
                                'value' => set_value('notes', $is_edit ? $invoice->notes : Settings::get('default_invoice_notes')),
                                'rows' => 4,
                                'cols' => 50
                            ));
                            ?>
                ...
                <div class="hide-estimate hide-credit-note">
                    <div class="gateway-items row">
                        ...
                        <?php $checked = Gateway::get_item_gateways('INVOICE', $is_edit ? $invoice->id : 0); ?>
