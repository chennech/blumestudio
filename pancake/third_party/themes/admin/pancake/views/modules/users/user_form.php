        ...
        <div class="row user-form form-holder">
            ...
            <div class="eight columns">
                ...
                <div class="row add-bottom">
                    ...
                    <div class="six columns end">
                        <span class="sel-item"><?php echo form_dropdown(($action == 'create' ? 'group' : 'group_id'), $groups, set_value('group', isset($member->group_id) ? $member->group_id : ""), (IS_DEMO ? 'disabled="disabled"' : '')); ?></span>
                    </div>
                    <!-- /8 -->
                </div>
                <!-- /row -->
