...
<div class="row mailpane">
    ...
    <div id="ticket-body" class="eight columns">
        ...
        <div id="ticket-actions">
            <div class="row">
                <div class="seven columns"><strong><?php echo $current_ticket->subject ?></strong> - <strong><?php echo $current_ticket->client_first_name . ' ' . $current_ticket->client_last_name; ?></strong></div>
                <div class="five columns align-right">
                    <strong>
                        <?php echo __('tickets:ticket_number', array($current_ticket->id)); ?>
                        <?php if ($current_ticket->is_billable) : ?>
        ...
        <div id="ticket-content">
            <?php if ($current_ticket->is_billable and ! $current_ticket->invoice_id) : ?>
