...
<<?php echo $is_dashboard ? "div" : "li"; ?> id="task-row-<?php echo $task['id']; ?>" data-parent-id='<?php echo $task['parent_id']; ?>' class="<?php echo url_title($task['status_title'], '-', true); ?> task-item">
<div class="row dashboard-task <?php echo ($task['due_date'] > time()) ? "not-due" : "overdue"; ?> task-<?php echo $task['id'] ?>" style="margin-bottom: 0.5em" >
    ...
    <div class="twelve columns">
        ...
        <?php endif; ?>
                ...
                <span class="js-task-complete-status <?php echo ((bool) $task['completed']) ? 'completed' : 'incomplete'; ?>"><?php echo $task['name']; ?></span></p>
...
<?php endif; ?>
		            ...
		            <a class="task-notes-link" title="<?php echo __("tasks:task_notes"); ?>" href="#" data-pancake-modal-id="notes-<?php echo $task['id'] ?>"><i class="fi-page-add"></i></a>
