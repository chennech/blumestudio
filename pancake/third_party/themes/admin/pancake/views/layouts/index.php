...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    <head>
        ...
        <?php endif; ?>
        <script src="<?php echo site_url("admin/dashboard/setup_js/" . crc32(get_setup_js()) . '.js'); ?>"></script>
    ...
    <body id="body-wrap" class="module-<?php echo str_ireplace('/', '-', $this->router->fetch_module()); ?> controller-<?php echo $this->router->fetch_class(); ?> action-<?php echo $this->router->fetch_method(); ?> <?php echo is_admin() ? 'admin' : 'not-admin';?> <?php echo (isset($iframe)) ? ($iframe ? 'iframe' : '') : ''; ?> not-login-layout main-layout">
                        ...
                        <li class="has-dropdown">
                            ...
                            <ul class="dropdown">
                                <?php if (is_admin()): ?>
                                    ...
                                    <li class="pancake-navigation-label-container"><label class="pancake-navigation-label"><?php echo __('global:settings'); ?></label></li>
                                    <li><a href="<?php echo site_url('admin/settings#general') ?>"><?php echo __('settings:general'); ?></a></li>
                                    <li><a href="<?php echo site_url('admin/settings#identities') ?>"><?php echo __('settings:business_identities') ?></a></li>
                                    ...
                                    <li><a href="<?php echo site_url('admin/settings#update') ?>"><?php echo __('global:update') ?></a></li>
                                    <li><a href="<?php echo site_url('admin/settings#errors_and_diagnostics') ?>"><?php echo __('settings:errors_and_diagnostics') ?></a></li>
                                    ...
                                    <li><a href="<?php echo site_url('admin/settings#tickets') ?>"><?php echo __('global:tickets') ?></a></li>
                ...
                <div class="row">
                    ...
                    <div class="eight columns align-right">
                        <div class="pancake-version clearfix">
                            ...
                            <p><a target="_blank" href="<?php echo PANCAKEAPP_COM_BASE_URL; ?>blog/entry/pancake-<?php echo Settings::get('version'); ?>-released"><strong style="font-size: 16px;">Pancake</strong> <br /> <?php echo __('global:version', array(Settings::get('version'))); ?></a></p>
                        </div>
                        <?php $post = Settings::get_latest_blog_post(); ?>
                        <?php if ($post): ?>
                        <div class="latest-blog-post">
                            <a target="_blank" href="<?php echo $post['url']; ?>">
                                <strong style="font-size: 16px;"><?php echo $post['title'];?></strong><br />
                                posted on <?php echo format_date($post['published_on']); ?>
                            </a>
                        </div>
                        <?php endif; ?>
                    </div>
