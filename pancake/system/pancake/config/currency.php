...
$config['currencies'] = array(
    ...
    'EUR' => array('symbol' => '&euro;', 'name' => 'Euro'),
    'GBP' => array('symbol' => '&pound;', 'name' => 'Pound Sterling'),
    ...
    'PHP' => array('symbol' => 'P', 'name' => 'Philippine Peso'),
    'ZAR' => array('symbol' => 'ZAR', 'name' => 'South African Rand'),
    'INR' => array('symbol' => 'INR', 'name' => 'Indian Rupee'),
    'IDR' => array('symbol' => 'Rp', 'name' => 'Indonesian Rupiah'),
    'SAR' => array('symbol' => 'SAR', 'name' => 'Saudi riyal'),
    ...
    'TWD' => array('symbol' => 'NT$', 'name' => 'Taiwan New Dollar'),
    'THB' => array('symbol' => '฿', 'name' => 'Thai Baht'),
    'DOP' => array('symbol' => 'RD$', 'name' => "Dominican Peso")
);

/* Location: ./application/config/currency.php */