...
class Timesheet_m extends Pancake_Model
{
	...
	public function build_timesheet($user=null, $start_time=null, $end_time=null)
	{
		...
		return $this->db
			->select("{$this->times_table}.*, users.username, users.email, projects.name as project_name, clients.company as company, clients.id as client_id, meta.first_name, meta.last_name, project_tasks.name as task_name, (CEILING(minutes / $task_time_interval) * $task_time_interval) as rounded_minutes")
