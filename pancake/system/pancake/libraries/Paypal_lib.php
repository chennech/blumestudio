...
class Paypal_lib {
	...
	function __construct()
	{
		...
		$this->ipn_url = ($this->sandbox) ? 'ssl://www.sandbox.paypal.com' : $this->paypal_url;
	...
	function validate_ipn()
	{
		...
		$url = ($this->sandbox ? $this->ipn_url : $url_parsed['host']);
		$port = ($this->sandbox ? 443 : 80);

		// open the connection to paypal
		$fp = fsockopen($url, $port, $err_num, $err_str, 30);
		if(!$fp)
		{
