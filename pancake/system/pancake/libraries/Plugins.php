...
class Plugins
{
	...
	public static function get($name){   
		...
		return trim(self::$_settings[$name]);
	}
	...
	/**
	 * Create a new entry in the plugins table.
	 * @param string $name The key of the value to store.
	 * @param mixed $value The value to store.
	 */
	...
	public function reload()
	{
		...
		//this is just a hack, i couldn't figure out how to not run this without migrations.
	
		foreach ($this->_ci->plugins_m->get_all() as $setting){
			Plugins::$_settings[$setting->slug] = $setting->value;
		}	
