...
<p style="font-size:90%">Please note, <strong>if you have already installed Pancake and are upgrading DO NOT</strong> continue with these steps. This will overwrite your existing Pancake tables, you need to put your database.php back in the config folder. If you need help with this please email <?php echo safe_mailto('support@pancakeapp.com') ?> and we will help you along.</p>
<?php if (isset($error)): ?>
